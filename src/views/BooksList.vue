<template>
  <v-container grid-list-xs fluid>
    <v-layout align-start justify-start row wrap >
      <v-flex d-flex xs4 sm3 md2 lg2 xl1 v-for='book in getFilterdBooks' v-bind:key='book.ISBN'>
          <v-layout align-center justify-start column>
            <v-flex d-flex>
              <img v-lazy='book.Cover' class="grey lighten-4" width="128px" height="166px" 
