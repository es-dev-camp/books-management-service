  ...
  <v-container fill-width fluid grid-list-xl>
    <v-layout row justify-center>
      ...
      >
        ...
        <v-icon size='16' @click='snack.IsVisible = false'>mdi-close-circle</v-icon>
      </v-snackbar>
    </v-layout>
        ...
        <v-card>
          ...
          <v-list two-line>
            <v-list-tile>
              ...
              <v-list-tile-content>
                <v-list-tile-title> {{ registeredBook.Comment }} </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            ...
            <v-list-tile>
              ...
              <v-list-tile-content>
                <v-list-tile-title> {{ registeredBook.PublishDate }} </v-list-tile-title>
            ...
            <v-list-tile>
              ...
              <v-list-tile-content>
                <v-list-tile-title> {{ registeredBook.ModifiedInfo }} </v-list-tile-title>
            ...
            <v-list-tile>
              ...
              <v-list-tile-content>
                <v-list-tile-title> {{ registeredBook.CreatedInfo }} </v-list-tile-title>
                <v-list-tile-sub-title></v-list-tile-sub-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list>
...
export default class Register extends Vue {
  ...
  private async AddBook(): Promise<void> {
    ...
    const book = await Book.Init(this.isbn, this.$store.getters.User.Id) as IBook;
    if (book === null) {
      this.ShowSnack('warning', `Not found book infomation ${this.isbn}`, ['top']);
      this.ClearInput();
      return;
    }
